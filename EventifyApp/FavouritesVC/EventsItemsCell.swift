...
final class EventsItemsCell: UICollectionViewCell {
    static let cellId = "EventsItemsCell"
    ...
    private func setupViews() {
        ...
        contentView.addSubviews(imageView, likeButton, title, dayContainer, timeContainer, audienceContainer)
    ...
    private func setupLayout() {
        ...
        audienceContainer.snp.makeConstraints({
            $0.top.equalTo(dayContainer.snp.top)
            $0.leading.equalTo(timeContainer.snp.trailing).offset(4)
            $0.height.equalTo(20)
        })
    ...
    func configureCell(with model: FavouritesEventModel) {
